    ...
    <main className="min-h-screen bg-white flex flex-col">
      ...
      <section className="relative w-full h-[65vh] min-h-[550px] flex items-center justify-center overflow-hidden">
        ...
        <div 
          ...
          style={{ backgroundImage: "url('/section_1.png')" }} 
        >
      ...
      <section className="py-12 sm:py-24 max-w-5xl mx-auto px-4 w-full">
         ...
         >
            ...
            <p className={`${inter.className} text-gray-600 text-[15px] sm:text-[17px] leading-[1.8]`}>
              Listelenen fiyat aralıkları Çınar Kurban Tesisi'nin 2026 yılı için açıkladığı ön kayıt değerleridir. Kesin fiyatlar Kurban bayramına ortalama 2 ay kala piyasa şartları göz önünde bulundurularak resmileşecek olup, yatırdığınız kapora (ön ödeme) toplam hisse tutarınızdan düşülecektir. Memnun kalmamanız durumunda şartsız koşulsuz <span className="font-bold text-gray-900">tam iade hakkınız garanti altındadır.</span>
            </p>
         </motion.div>
      </section>
